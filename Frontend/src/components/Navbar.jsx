...
function Navbar() {
  ...
  return (
    ...
    ${sticky?" sticky-navbar shadow-md dark:bg-slate-900 dark:text-white bg-base-300 duration-300 transition-all ease-in-out":""
    } `}>
  ...
  <div className="navbar-start">
    <div className="dropdown">
      ...
      <ul tabIndex={0} className="menu menu-sm dropdown-content mt-3 z-[1] p-2 shadow bg-base-100 rounded-box w-52 dark:bg-slate-900">
        {navItems}
      </ul>
    </div>
  ...
  <input type="text"
   className=" grow outline-none px-2 dark:bg-slate-900 dark:text-white" 
   placeholder="Search" />
  ...
  <div className=' mx-2'>
    <a className=" bg-black text-white px-3 py-2 rounded-md hover:bg-slate-700 cursor-pointer">Login</a>
    </div>
</div>
</div>
    </div>
